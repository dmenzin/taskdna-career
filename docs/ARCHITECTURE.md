...
- `src/lab`: Virtual Subject Laboratory and logic-audit harness. Hidden truth lives here only; the production engine does not import it.
- `scripts`: reproducible seed, reset, eval, audit, subject-lab, and export commands.
